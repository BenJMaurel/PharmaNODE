...
if __name__ == "__main__":
    ...
    axes[1,0].text(12, 10, "Linear Decay", ha='center', color='black', fontweight='bold', bbox=dict(facecolor='white', alpha=0.7))
    ...
    axes[1,2].set_ylabel("")
    axes[1,2].text(12, 10, "Non-Linear Decay ", ha='center', color='darkred', fontweight='bold', bbox=dict(facecolor='white', alpha=0.7))
