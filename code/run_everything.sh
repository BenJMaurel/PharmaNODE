...
BASE_COMMAND_TRAIN="$PYTHON_SCRIPT_TRAIN --niters 6000 -n 200 -s 40 -l 10 --dataset PK_Tacro --latent-ode --noise-weight 0.01 --max-t 5. -b 512"
...
for SEED in $(seq "$START_SEED" "$END_SEED"); do
    ...
    R_CMD=(xvfb-run -a -s "-screen 0 1024x768x24" Rscript "$BASE_COMMAND_R"
