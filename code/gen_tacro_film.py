...
def generate_virtual_cohort_film(num_patients=10, scenario=1):
    ...
    dose_list = np.array([2.0, 2.5, 3.0, 3.5, 4.0, 4.5, 5.0])
...
if __name__ == '__main__':
    ...
    train_df.to_csv(f'./results/exp_film_run/{args.exp}/virtual_cohort_film_train.csv', index=False)
    test_df.to_csv(f'./results/exp_film_run/{args.exp}/virtual_cohort_film_test.csv', index=False)
